...
export class ApiService {
  public static URL_USERS:string = 'https://jsistudentportal.000webhostapp.com/user/users.php';
  ...
  public users(): Promise<Response> {
    return this.http.get(ApiService.URL_USERS)
      .toPromise()
      .then(value => value)
      .catch(reason => reason);
  }
